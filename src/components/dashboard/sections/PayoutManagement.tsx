...
export function PayoutManagement() {
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      const result = await sellersApi.updatePayoutStatus(
                  ...
                  >
                    <TableCell className="py-4 px-0">
                      <div className="font-mono text-sm text-gray-900 font-medium">
                        {payout.payout_id || "N/A"}
                        <p className="text-sm text-gray-500">
                        #{payout.shopify_order_number || 'N/A'}
                        </p>
                      </div>
                    </TableCell>
                    ...
                    <TableCell className="py-4 px-0">
                      <div className="space-y-1">
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            onClick={() =>
                              handleWhatsAppClick(payout.whatsapp_number || "")
                            }
                    ...
                    <TableCell className="py-4 px-0">
                      <Badge
                        ...
                        className={`flex items-center gap-1 w-fit rounded-full ${getStatusBadgeClass(
                          payout.status
                        )}`}
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-lg font-bold text-gray-900">
                        €
                        {parseFloat(
                          selectedPayout.seller_payout_amount
                        ).toFixed(2)}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="text-sm text-gray-900 font-mono">
                        {selectedPayout.iban || "NL89 3704 0044 0532 0130 00"}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-medium text-gray-500">
                      ...
                      <span className="text-sm text-gray-900">
                        {selectedPayout.bank_name || "ING Bank"}
                      </span>
                    </div>
                    <div className="flex justify-between items-center">
                      <span className="text-sm font-medium text-gray-500">
                      ...
                      <span className="text-sm text-gray-900 capitalize">
                        {selectedPayout.payment_schedule || "Bi Weekly"}
                      </span>
                    </div>
                  </div>
                </div>
